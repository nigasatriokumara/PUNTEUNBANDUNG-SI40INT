...
public class InputEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eTTitile = (EditText) findViewById(R.id.editTitleEvent);
        eTDeskripsi = (EditText) findViewById(R.id.editDeskripsiEvent);
        btnPilihFoto = (Button) findViewById(R.id.pilihFotoEvent);
        btnInputEvent = (Button) findViewById(R.id.inputEvent);

        imageView = (ImageView) findViewById(R.id.slideimg6);
        databasePuntenBandung = FirebaseDatabase.getInstance().getReference("EventData");
        ...
        btnInputEvent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addEvent();
            }
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        if(task.isSuccessful()) {
                           ...
                           Event event = new Event(id,nama,desk,img_url);
                           databasePuntenBandung.child(id).setValue(event);
                           Toast.makeText(InputEventActivity.this, "berhasil ditambahkan", Toast.LENGTH_SHORT).show();
                           eTTitile.setText("");
                           eTDeskripsi.setText("");
